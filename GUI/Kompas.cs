...
namespace GUI
{
    ...
    internal class Kompas
    {
        ...
        private void DrawSection(ksPart windowPart, ksEntity planeXoy, 
            ...
            double yStartNotch, double widthNotch,
            double heighNotch, double weigthNotch)
        {
            ExtrudeOdject(height, width, weigth, windowPart, planeXoy,
                xStartExtrude, yStartExtrude,
                Obj3dType.o3d_bossExtrusion);
            ExtrudeOdject(heighNotch, widthNotch, weigthNotch, windowPart,
                CreateOffsetPlane(windowPart, planeXoy, weigthNotch),
                xStartNotch, yStartNotch,
